...
export default function PopUp({isOpenPopup,setIsOpenPopup, popupMessage}){
    ...
    return <>
        ...
        onClick={handleClick}>
            <div className="bg-white min-w-[20rem] h-[15rem] flex flex-col
            items-center justify-center gap-5 rounded-3xl shadow-xl">
                <h2 className="font-Poppins font-bold text-lg">{popupMessage}</h2>
                <button className=""
